...
function gallery() { return layout(`${pageHero("Gallery", "A glimpse inside Visiona.", "Temporary imagery for the prototype. The store owner can replace every image later from the media folder or CMS integration.")}
